...
public class GetNameInBackground extends AbstractGetNameTask {
    ...
    protected String fetchToken() throws IOException {
        try {
            return GoogleAuthUtil.getTokenWithNotification(mActivity, mEmail, mScope, null, makeCallback(mEmail));
    ...
    private Intent makeCallback(String accountName) {
        ...
        /*
         * TODO Not needed, do something else here
         * intent.putExtra(BaseActivity.EXTRA_ACCOUNTNAME, accountName);
         * intent.putExtra(BaseActivity.TYPE_KEY,
         * BaseActivity.Type.BACKGROUND.name());
         */
        return intent;
    }
