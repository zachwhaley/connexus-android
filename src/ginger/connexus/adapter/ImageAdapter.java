 ...
 */
public class ImageAdapter extends ArrayAdapter<ImageWrapper> {
    ...
    public ImageAdapter(Context context, ImageWrapper.List images, ImageFetcher imageFetcher) {
        super(context, -1, -1, images);
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        // runs
        mImageFetcher.loadImage(getItem(position).getUrl(), imageView);
        return imageView;
    }
